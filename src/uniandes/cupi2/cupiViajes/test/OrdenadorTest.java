...
public class OrdenadorTest extends TestCase {
    ...
    protected void setUp()
    {
        ...
        reservas.add(new ReservaViaje( "Juan", 5, 2, 5, Aerolinea.AVIANCA, hotel4, c.getTime( ) ));
        c.set( 2016, Calendar.DECEMBER, 10 );
        reservas.add(new ReservaViaje( "Maria", 3, 0, 4, Aerolinea.AVIANCA, hotel5, c.getTime( ) ));
        c.set( 2016, Calendar.DECEMBER, 6 );
        reservas.add(new ReservaViaje( "Pedroa", 2, 0, 7, Aerolinea.AVIANCA, hotel6, c.getTime( ) ));
        c.set( 2015, Calendar.FEBRUARY, 1 );
        reservas.add(new ReservaViaje( "Ana", 1, 5, 3, Aerolinea.AVIANCA, hotel6, c.getTime( ) ));
        c.set( 2016, Calendar.MARCH, 14 );
        reservas.add(new ReservaViaje( "Pepe", 4, 8, 2, Aerolinea.AVIANCA, hotel5, c.getTime( ) ));
        c.set( 2015, Calendar.MARCH, 13 );
        reservas.add(new ReservaViaje( "Diana", 8, 3, 5, Aerolinea.AVIANCA, hotel4, c.getTime( ) ));
